...
namespace MNPR.MNPREditor
{
    internal class StandardShaderGUIBase : ShaderGUI
    {
        ...
        protected MaterialProperty metallicMap = null;
        ...
        protected MaterialProperty highlights = null;
        protected MaterialProperty reflections = null;
        ...
        protected const float kMaxfp16 = 65536f; // Clamp to a value that fits into fp16.
        protected ColorPickerHDRConfig m_ColorPickerHDRConfig = new ColorPickerHDRConfig(0f, kMaxfp16, 1 / kMaxfp16, 3f);
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            FindPropertiesEx(props);
        }
        public virtual void FindPropertiesEx(MaterialProperty[] props)
        {
        ...
        protected  void DoNormalArea()
        {
            ...
            if (bumpScale.floatValue != 1 && UnityEditorInternal.InternalEditorUtility.IsMobilePlatform(EditorUserBuildSettings.activeBuildTarget))
                if (m_MaterialEditor.HelpBoxWithButton(new GUIContent("Bump scale is not supported on mobile platforms"), 
                    new GUIContent("Fix Now"))) // Fixed It By Use Diffrent Way Cause TextContent API Did Not Found
